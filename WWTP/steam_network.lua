--[[-------------------------------------------------------------------------------------------------------------------
# TB CASE STUDY (RECOVERY BOILER FURNACE)
...
-----------------------------------------------------------------------------------------------------------------------
model.Class = {Group = 'recovery_boiler', Type = 'pulp&paper', SubType = 'recovery_boiler steam generator of kraft pulp mill'}
-----------------------------------------------------------------------------------------------------------------------
model.Tagging = {TagName = 'recovery_boiler_steam', DisplayName = 'recovery_boiler_steam', Description = 'recovery_boiler_steam'}
-----------------------------------------------------------------------------------------------------------------------
model.author = {{Id = 1, Author = 'MAZIAR KERMANI', Date = '23-MAR-2018', ChangeLog = 'first version'}}
-----------------------------------------------------------------------------------------------------------------------
model.values = {}
-----------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------
model.inputs.supdT01              = {default = 150, unit = 'C', description ='superheat at 1st level'} 
...
model.inputs.fmax_pump            = {default = 4000, unit = '-', description ='size'}
model.inputs.fmin_header          = {default = 0, unit = '-', description ='size'}
model.inputs.fmax_header          = {default = 500, unit = '-', description ='size'}
model.inputs.fmin_drawoff         = {default = 0, unit = '-', description ='size'}
model.inputs.fmax_drawoff         = {default = 500, unit = '-', description ='size'}
model.inputs.fmin_td              = {default = 0, unit = '-', description ='size'}
model.inputs.fmax_td              = {default = 20000, unit = '-', description ='size'}
model.inputs.fmin_trh             = {default = 0, unit = '-', description ='size'}
model.inputs.fmax_trh             = {default = 20000, unit = '-', description ='size'}
model.inputs.fmin_text            = {default = 0, unit = '-', description ='size'}
model.inputs.fmax_text            = {default = 70000, unit = '-', description ='size'}
-----------------------------------------------------------------------------------------------------------------------
